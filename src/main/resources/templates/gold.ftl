		...
		url: "encode",
			...
			success : function(msg) {
				...
				$.ajax({
		           ...
		           success : function(msg) {		         
		              //alert("Message============="+msg);
		              //alert(msg.substr(0,1));
		              var bankFlag=msg.substr(0,1);
		              //alert("bankFlag============="+bankFlag);
		              if(bankFlag=="1"||bankFlag=="2"||bankFlag=="5"){
		                 alert("金库校验成功 [bankFlag="+bankFlag+"]");
		                 document.getElementById("tokenResult").value = "TokenValidateResult============>\t"+msg;
		              }else{
		                 alert("金库校验成功 [bankFlag="+bankFlag+"]");
		                 document.getElementById("tokenResult").value = "TokenValidateResult============>\t"+msg;	              
		              }
		             
		              //var bankFlag=msg.substring(0,1);
		              //if(
		              //bankFlag=="1"||bankFlag=="2"||bankFlag=="5"){
		                 //alert("金库校验成功 [bankFlag="+bankFlag);
		              //}else{
		                //alert("金库校验失败 [bankFlag="+bankFlag);
		              //}
		           }
		...
		<div class="main">
			...
			<div class="main_con2" id="main_con_div">
				<table>
					...
					<tr>
						<td colspan="1">
							<div id="c1" class="button03" onclick='does_decrypt();'>Triple解密</div>
						</td>
						<td colspan="5"><textarea id="ciphertxt" rows="3" cols="100">EBFF41235F699D95184D59B9CD6FE13D</textarea></td>
					</tr>
					<tr>
						<td colspan="1">
							<div id="c1" class="button03" onclick='does_decrypt();'>Token校验结果</div>
						</td>
						<td colspan="5"><textarea id="tokenResult" rows="3" cols="100"></textarea></td>
					</tr>
				</table>
