package org.lykj.tomcat.webservice.impl;

import lombok.extern.slf4j.Slf4j;
import org.lykj.tomcat.entity.ReturnValue;
import org.lykj.tomcat.webservice.ServerServiceDemo;
...
@WebService(name = "ServerServiceDemo", targetNamespace = "http://org.lykj.ws",
        endpointInterface = "org.lykj.tomcat.webservice.ServerServiceDemo")
public class ServerServiceDemoImpl implements ServerServiceDemo {
    ...
    @Override
    public String getAuditTaskService(@WebParam String RequestInfo) {
        log.info(RequestInfo);
        return null;
    }

    @Override
    public String IsHandler(@WebParam String username, @WebParam String mobileNumber, @WebParam String orderCode) {
        log.info(username);
        return null;
    }

    @Override
    public String IsHandlerHis(@WebParam String username, @WebParam String mobileNumber, @WebParam String orderCode) {
        log.info(username);
        return null;
    }

    @Override
    public ReturnValue authenticateStaticPassword(String uid, String pwd){
         return new ReturnValue(0,1,"成功");
    }
}